...
airflow_env_vars=(
    ...
    AIRFLOW_ROLES_SYNC_AT_LOGIN
    AIRFLOW_ROLES_MAPPING
    AIRFLOW_LDAP_SERVER
    AIRFLOW_LDAP_BIND_USER
    AIRFLOW_LDAP_BIND_PASSWORD
    AIRFLOW_LDAP_TLS_DEMAND
    AIRFLOW_LDAP_TLS_CACERTDIR
    AIRFLOW_LDAP_TLS_CACERTFILE
    AIRFLOW_LDAP_TLS_CERTFILE
    AIRFLOW_LDAP_TLS_KEYFILE
    AIRFLOW_LDAP_SEARCH
    AIRFLOW_LDAP_SEARCH_FILTER
    AIRFLOW_LDAP_UID_FIELD
    AIRFLOW_LDAP_GROUP_FIELD
    AIRFLOW_LDAP_FIRSTNAME_FIELD
    AIRFLOW_LDAP_LASTNAME_FIELD
    AIRFLOW_LDAP_EMAIL_FIELD
    AIRFLOW_LDAP_ALLOW_SELF_SIGNED
    AIRFLOW_LDAP_APPEND_DOMAIN
    AIRFLOW_LDAP_USERNAME_FORMAT
    AIRFLOW_ROLE_ADMIN
    AIRFLOW_ROLE_PUBLIC
)
...
export AIRFLOW_LDAP_ENABLE="${AIRFLOW_LDAP_ENABLE:-no}"
export AIRFLOW_LDAP_USE_TLS="${AIRFLOW_LDAP_USE_TLS:-False}"
export AIRFLOW_USERNAME_CI="${AIRFLOW_USERNAME_CI:-}"
export AIRFLOW_USER_REGISTRATION_ROLE="${AIRFLOW_USER_REGISTRATION_ROLE:-Public}"
export AIRFLOW_ROLES_SYNC_AT_LOGIN="${AIRFLOW_ROLES_SYNC_AT_LOGIN:-}"
export AIRFLOW_ROLES_MAPPING="${AIRFLOW_ROLES_MAPPING:-}"
export AIRFLOW_LDAP_SERVER="${AIRFLOW_LDAP_SERVER:-}"
export AIRFLOW_LDAP_BIND_USER="${AIRFLOW_LDAP_BIND_USER:-}"
export AIRFLOW_LDAP_BIND_PASSWORD="${AIRFLOW_LDAP_BIND_PASSWORD:-}"
export AIRFLOW_LDAP_TLS_DEMAND="${AIRFLOW_LDAP_TLS_DEMAND:-}"
export AIRFLOW_LDAP_TLS_CACERTDIR="${AIRFLOW_LDAP_TLS_CACERTDIR:-}"
export AIRFLOW_LDAP_TLS_CACERTFILE="${AIRFLOW_LDAP_TLS_CACERTFILE:-}"
export AIRFLOW_LDAP_TLS_CERTFILE="${AIRFLOW_LDAP_TLS_CERTFILE:-}"
export AIRFLOW_LDAP_TLS_KEYFILE="${AIRFLOW_LDAP_TLS_KEYFILE:-}"
export AIRFLOW_LDAP_SEARCH="${AIRFLOW_LDAP_SEARCH:-}"
export AIRFLOW_LDAP_SEARCH_FILTER="${AIRFLOW_LDAP_SEARCH_FILTER:-}"
export AIRFLOW_LDAP_UID_FIELD="${AIRFLOW_LDAP_UID_FIELD:-}"
export AIRFLOW_LDAP_GROUP_FIELD="${AIRFLOW_LDAP_GROUP_FIELD:-}"
export AIRFLOW_LDAP_FIRSTNAME_FIELD="${AIRFLOW_LDAP_FIRSTNAME_FIELD:-}"
export AIRFLOW_LDAP_LASTNAME_FIELD="${AIRFLOW_LDAP_LASTNAME_FIELD:-}"
export AIRFLOW_LDAP_EMAIL_FIELD="${AIRFLOW_LDAP_EMAIL_FIELD:-}"
export AIRFLOW_LDAP_ALLOW_SELF_SIGNED="${AIRFLOW_LDAP_ALLOW_SELF_SIGNED:-True}"
export AIRFLOW_LDAP_APPEND_DOMAIN="${AIRFLOW_LDAP_APPEND_DOMAIN:-}"
export AIRFLOW_LDAP_USERNAME_FORMAT="${AIRFLOW_LDAP_USERNAME_FORMAT:-}"
export AIRFLOW_ROLE_ADMIN="${AIRFLOW_ROLE_ADMIN:-}"
export AIRFLOW_ROLE_PUBLIC="${AIRFLOW_ROLE_PUBLIC:-}"
